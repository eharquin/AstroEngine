...
void AgCamera::setOrthographicProjection(float left, float right, float top, float bottom, float near, float far)
{
	proj = glm::mat4{ 1.0f };
...
void AgCamera::setPerspectiveProjection(float fovy, float aspect, float near, float far)
{
...
void AgCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up)
{
...
//   up:       up direction of the camera (should be normalized and perpendicular to direction)
void AgCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up)
{
...
void AgCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation)
{
