...
ImageViews::ImageViews(LogicalDevice& logicalDevice, SwapChain& swapChain) : logicalDevice(logicalDevice), swapChain(swapChain)
{
	createImageViews();
}
...
void ImageViews::createImageViews()
{
	...
	for (size_t i = 0; i < swapChainImages.size(); i++)
	{
		...
		createInfo.format = swapChain.getVkFormat();
